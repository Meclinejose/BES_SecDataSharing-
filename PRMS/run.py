...
def callmain(ks,ID,User_Password,do_Pw,server_password,AA_Password,n_usr,a, b, c, d, r, x, x1, x2, y1, y2, f, g, h,Data,Norm_V,PRI):
    ...
    for i in range(n_usr):
        ...
        En_data= PRMS.Block_chain.Encrypytion(Data)


        Gen_key=PRMS.Block_chain.Key_generation(Data, En_data, DO_ID, ks, r, y1, y2, x1, x2, d, priv, nv)

        De_Data = PRMS.Block_chain.Decryption(Data, DO_ID, DO_Pw, a, b, c, d, f, g, h, x, x1, x2, y1, y2, r, Gen_key)
